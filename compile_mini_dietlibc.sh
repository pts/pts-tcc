...
# Compiles with: --gcc -gcc=clang --gcc=4.4 --tcc --pcc.
../pathbin/minicc --gcc --diet -DCONFIG_TCCDIR='"/dev/null"' -DTCC_VERSION='"0.9.26-1"' -DTCC_VERSION10000=92600 -DTCC_TARGET_I386 -DCONFIG_TCC_STATIC -DCONFIG_NO_RUN -DCONFIG_NO_EXEC -fno-strict-aliasing \
