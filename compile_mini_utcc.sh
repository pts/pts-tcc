...
../pathbin/minicc --gcc=4.8 -nostdinc -nostdlib -I"$UCLIBC_LIBDIR"/../include -Icc_include \
    -DCONFIG_TCCDIR='"/dev/null"' -DTCC_VERSION='"0.9.26-2"' -DTCC_VERSION10000=926 -DTCC_TARGET_I386 -DCONFIG_TCC_NO_BCHECK -DCONFIG_TCC_STATIC -DCONFIG_TCC_STATIC_LINK_ONLY -DCONFIG_TCC_DATA -DCONFIG_PREDEF_UCLIBC -DCONFIG_NO_SYSINCLUDE -DCONFIG_NO_RUN -DCONFIG_NO_EXEC -fno-strict-aliasing \
