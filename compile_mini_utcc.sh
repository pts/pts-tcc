...
../pathbin/minicc --gcc=4.8 -nostdinc -nostdlib -I"$UCLIBC_LIBDIR"/../include -Icc_include \
    -DCONFIG_TCCDIR='"/dev/null"' -DTCC_VERSION='"0.9.26-1"' -DTCC_VERSION10000=92600 -DTCC_TARGET_I386 -DCONFIG_TCC_STATIC -DCONFIG_TCC_DATA -DCONFIG_NO_RUN -DCONFIG_NO_EXEC -fno-strict-aliasing \
