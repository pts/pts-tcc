...
if ! test -f tcc-0.9.26/config.h; then
  ...
  # (cd tcc-0.9.26 && noldl=yes ./configure --cc=false --extra-cflags='-DCONFIG_TCC_STATIC -DCONFIG_TCC_STATIC_LINK_ONLY') || die "configure failed"
